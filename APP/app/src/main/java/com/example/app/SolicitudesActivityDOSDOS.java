...
public class SolicitudesActivityDOSDOS extends AppCompatActivity {

    RecyclerView rvListaS;
    AdaptadorMisServicios adaptador;
    List<MisServicios> listaMisServicios;
    String correo, id_usuario, tecnico;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_listarmisservicioschat);
                    ...
                    adaptador = new AdaptadorMisServicios(getApplicationContext(), listaMisServicios);
                        adaptador.setOnClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View view) {
                                    ...
                                    servicio = listaMisServicios.get(rvListaS.getChildAdapterPosition(view)).getId_servicio_tecnico();
                                    id_tecnico = listaMisServicios.get(rvListaS.getChildAdapterPosition(view)).getId_tecnico();

                                    Intent intent = new Intent(getApplicationContext(), SolicitudesActivityDOS.class);
                                    intent.putExtra("email", correo);
                                    intent.putExtra("id_servicio",  servicio+"");
